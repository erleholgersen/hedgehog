...
By default, all background points are grey. We can change this by using the `points.col` argument. It is passed straight to `stripchart`, and thus follows the stripchart convention of assigning colours by grouping variable. 
